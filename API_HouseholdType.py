...
for area, area_geom in zip(areas, areas_geom):
    ...
    feature = {
        ...
        "properties": {
            "planning_area": area,
            "housing_type_hdb_1_and_2_room_flats": item["hdb_1_and_2_room_flats"],
            "housing_type_hdb_3_room_flats": item["hdb_3_room_flats"],
            "housing_type_hdb_4_room_flats": item["hdb_4_room_flats"],
            "housing_type_hdb_5_room_and_executive_flats": item["hdb_5_room_and_executive_flats"],
            "housing_type_condominiums_and_other_apartments": item["condominiums_and_other_apartments"],
            "housing_type_landed_properties": item["landed_properties"],
            "housing_type_others": item["others"],
            "housing_type_year": item["year"],
            "housing_type_total_hdb": item["total_hdb"]
        }
    }
...
output_path = "sgp_household_type_data_area_2020.geojson"
